...
@push('title', get_phrase('Add New Package'))
@push('meta')@endpush
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="d-flex align-items-start justify-content-between gap-2 mb-20px">
                    <div class="d-flex justify-content-between align-items-start gap-12px flex-column flex-lg-row w-100">
                        <h1 class="ca-title-18px">{{ get_phrase('Add New Package ATLS') }}</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb cap-breadcrumb">
                                ...
                                <li class="breadcrumb-item cap-breadcrumb-item active" aria-current="page">{{ get_phrase('Add New') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <form action="{{ route('agent.packages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="date_range" class="form-control" placeholder="e.g., 15-20 Februari 2025" value="{{ old('date_range') }}" required>
                                @error('date_range')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="days" class="form-control" placeholder="e.g., Senin-Jumat" value="{{ old('days') }}" required>
                                @error('days')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="time" class="form-control" placeholder="e.g., 08:00 - 17:00 WIB" value="{{ old('time') }}" required>
                                @error('time')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="url" name="maps_link" class="form-control" placeholder="https://maps.google.com/..." value="{{ old('maps_link') }}">
                                @error('maps_link')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="quota" class="form-control" min="1" value="{{ old('quota', 20) }}" required>
                                @error('quota')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="bank_name" class="form-control" placeholder="e.g., BCA" value="{{ old('bank_name') }}" required>
                                @error('bank_name')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="contact_phone" class="form-control" placeholder="628xxxxxxxxxx" value="{{ old('contact_phone') }}" required>
                                @error('contact_phone')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">{{ get_phrase('Max size: 2MB. Format: JPG, PNG, GIF') }}</small>
                                @error('image')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">{{ get_phrase('Create Package') }}</button>
                        </div>
                    </form>
                </div>
            </div>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-header-area d-flex align-items-center justify-content-between">
                    ...
                    <div class="header-right-area d-flex align-items-center justify-content-end ms-auto">
                                ...
                                <div class="offcanvas-body">
                                    <nav class="header-nav">
                                        <ul class="header-nav-list">
                                            <li><a class="first-a" href="/about-us">{{ get_phrase('About') }}</a></li>
                                            <li><a class="first-a" href="#national-atls-schedule">{{ get_phrase('National ATLS Schedule') }}</a></li>
                                            <li><a class="first-a" href="http://www.atlsregionxvi.org">{{ get_phrase('ATLS Regional XVI') }}</a></li>
                                            <li><a class="first-a" href="https://www.facs.org">{{ get_phrase('ACS') }}</a></li>

                            ...
                            <div class="row">
                               ...
                               <div class="col-lg-3 col-md-4 col-6 mb-3">
                                    <div class="footer-middle-nav">
                                        ...
                                        <ul>
                                            <li><a href="#">{{get_phrase('Restaurant')}}</a></li>
                                            <li><a href="#">{{get_phrase('Hotel')}}</a></li>
                                            <li><a href="#">{{get_phrase('Beauty')}}</a></li>
                                            <li><a href="#">{{get_phrase('Real-Estate')}}</a></li>
                                            <li><a href="#">{{get_phrase('Car')}}</a></li>
                                        </ul>
                                    </div>
                               </div>
                               <div class="col-lg-3 col-md-4 col-6 mb-3">
